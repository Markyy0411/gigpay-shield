...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      createShieldedGig: (...args_1) => {
        if (args_1.length !== 5) {
          throw new __compactRuntime.CompactError(`createShieldedGig: expected 5 arguments (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        const projectName_0 = args_1[1];
        const amount_0 = args_1[2];
        const clientPubKey_0 = args_1[3];
        const freelancerPubKey_0 = args_1[4];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('createShieldedGig',
                                     'argument 1 (as invoked from Typescript)',
                                     'gigpay.compact line 11 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        ...
        const partialProofData = {
          input: {
            value: _descriptor_0.toValue(projectName_0).concat(_descriptor_1.toValue(amount_0).concat(_descriptor_0.toValue(clientPubKey_0).concat(_descriptor_0.toValue(freelancerPubKey_0)))),
        ...
        const result_0 = this._createShieldedGig_0(context,
                                                   partialProofData,
                                                   projectName_0,
                                                   amount_0,
                                                   clientPubKey_0,
    ...
    this.impureCircuits = {
      createShieldedGig: this.circuits.createShieldedGig
    };
  ...
  initialState(...args_0) {
    ...
    state_0.setOperation('createShieldedGig', new __compactRuntime.ContractOperation());
                                      ...
                                      [
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_8.toValue(0n),
                                                                                              alignment: _descriptor_8.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_0.toValue(projectName_0),
                                                                                              alignment: _descriptor_0.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } }]);
